...
import (
	...
	"snippetbox.guimochila.com/internal/validator"
)
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManager.Put(r.Context(), "flash", "Your signup was sucessful. Please login.")
...
func (app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MinChars(form.NewPassword, 8), "newPassword", "This field must be at least 8 character long")
